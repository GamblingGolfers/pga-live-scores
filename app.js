...
// --- AUCTION FUNCTIONS ---
const initializeAuctionFeature = async () => {
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // 3. Load core data and setup Leaderboard
    try {
        ...
        availableGamblers = configData.gamblers; // This now loads first, fixing the dropdown
