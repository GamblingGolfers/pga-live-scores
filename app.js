document.addEventListener('DOMContentLoaded', () => {
    ...
    const fetchLeaderboardData = () => {
        fetch(url, options)
            ...
            .then(data => {
                // --- NEW: Wrap all data processing in a try...catch block ---
                // This will catch any errors that happen while rendering the data.
                try {
                    ...
                    // If an error happens inside the 'try' block, this code will run
            ...
            .catch(fetchError => {
                // This block handles errors with the API call itself
                ...
                leaderboardBody.innerHTML = `<tr><td colspan="6" style="text-align: center; color: #d9534f;">
                    ...
                    <br><br>This is likely due to an invalid API key, exceeding usage limits, or a network issue.
                </td></tr>`;
            });
    };
